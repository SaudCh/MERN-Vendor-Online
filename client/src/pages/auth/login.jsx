            ...
            <div className="mb-12 md:mb-0 bg-white p-5 rounded shadow">
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center lg:text-left">
                  <button className="inline-block px-7 py-2 bg-secondary-900 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-secondary-700 hover:shadow-lg focus:bg-secondary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-secondary-800 active:shadow-lg transition duration-150 ease-in-out">
                    Login
                  </button>
                  <Link
                    to="/register"
